...
<body>
    ...
    function InitGrid(queryData) {
        ...
        $('#grid').datagrid({   //定位到Table标签，Table标签的ID是grid
            url: '../video/videoCommentVoJson.do',   //指向后台的Action来获取当前菜单的信息的Json格式的数据
           // title: '年龄分类',
            iconCls: 'icon-view',
            height: 400,
            ...
            columns: [[
                 { title: '用户评论ID', field: 'id', width: "20%"},
                 { title: '视频ID', field: 'videoID', width: "20%" },
                 { title: '用户ID', field: 'userID', width:"20%" },
                 { title: '评论内容', field: 'content', width:"20%" },
                 { title: '创建时间', field: 'created_string', width: "20%" }
